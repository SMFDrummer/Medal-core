...
infix fun ByteArray.encryptTwNetwork(identifier: String): String = Crypto.TwNetwork(identifier).encrypt(this)
infix fun String.decryptTwNetwork(identifier: String): ByteArray = Crypto.TwNetwork(identifier).decrypt(this)
...
object Crypto {
    ...
    fun getKey(identifier: String): ByteArray = getMD5("`jou*$identifier)xoj'").encodeToByteArray()
    ...
    fun getMD5(toBeHashed: String): String =
...
private fun main() {
    ...
    val data = Crypto.Gzip.decrypt(pr).parseObject()
    ...
    println(Crypto.Gzip.encrypt(Json.encodeToString(data4)) == pr)
}